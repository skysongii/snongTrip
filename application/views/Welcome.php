    ...
    <header id="header">
        <div class="d-flex flex-column">
            ...
            <div class="profile">
                ...
                <h1 class="text-light"><a href="index.html">sNong<br> 바로가기 서비스</a></h1>
                            ...
                            <div class="col-lg-6">
                                <ul>
                                    ...
                                    <li><i class="bi bi-chevron-right"></i> <strong>Website:</strong>
                                        <a href="https://github.com/skysongii?tab=repositories" onclick="window.open(this.href,'_blank'); return false;">https://github.com/skysongii?tab=repositories</a></li>
